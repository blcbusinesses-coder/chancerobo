...
export abstract class BaseAgent {
  ...
  get systemPrompt(): string {
    ...
    return (
      ...
      `\n- Media: show_youtube (embed a YouTube video ON SCREEN / on the projector — the right choice in projector mode), play_video (fullscreen native player), stop_video. Use show_youtube for "put a video on the projector".` +
